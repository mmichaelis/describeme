...
/**
 * <p>
 * Describes Arrays. The behavior is actually a try to adopt the behavior of
 * {@link Arrays#deepToString(Object[])} for example by detecting self-contained
 * arrays and to prevent endless recursion.
 * </p>
 *
 * @since 1.0.0
 */
public class ArrayDescriber extends AbstractStreamDescriber {
  ...
  /**
   * Constructor defining separators, pre- and postfix for describing arrays.
   */
